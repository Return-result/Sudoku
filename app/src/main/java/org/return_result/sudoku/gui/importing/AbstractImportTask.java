...
import org.return_result.sudoku.db.SudokuImportParams;
import org.return_result.sudoku.db.SudokuInvalidFormatException;
import org.return_result.sudoku.game.FolderInfo;
import org.return_result.sudoku.utils.Const;
 ...
 * 3) Add code to {@link org.return_result.sudoku.gui.SudokuImportActivity} which creates instance of your new class and
